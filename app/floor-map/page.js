...
export default function FloorMap() {
  return (
    <div className="pt-20 ">
      ...
      <div className=" md:w-[430px] flex flex-col justify-around   md:flex md:flex-row md:justify-around ">
          <div className="w-[300px] h-[184px] p-[10px] px-14 mx-auto border border-inherit  mt-7 md:w-[257px] md:h-[184px]   md:mt-[100px] md:left-[96px] md:p-[5px] md:gap-[5px] md:bg-[#FFFFFF]  md:drop-shadow-2xl md:shadow-[#000000] md:border md:border-3 md:flex md:flex-col">
            <div className="  md:w-[257px] md:h-[32px] md:top-[282px] md:left-[96px] md:p-[10px] md:gap-[5px] md:flex md:justify-around ">
               <p className="flex justify-around p-[10px]  text-[#AE0243] font-bold md:w-[130px] md:h-[20px] md:font-[Poppins] md:font-[600] md:text-[13px] md:text-[#AE0243] sm:font-bold">Floor Map Sections</p>           
            </div>
      ...
      <div className="w-[300px] h-[361px] mx-auto mt-7  flex flex-wrap justify-between md:w-[913px] md:h-[617px] md:mt-[100px]  md:left-[435] md:top-[282px] md:p-[10px] md:bg-[#FFFFFF] md:flex md:flex-wrap md:justify-between">
